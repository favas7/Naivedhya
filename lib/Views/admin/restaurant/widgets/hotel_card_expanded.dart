...
class RestaurantCardExpandedContent extends StatelessWidget {
  ...
  const RestaurantCardExpandedContent({
    super.key,
  ...
  Widget _buildDetailedInfo() {
    return Column(
      ...
      children: [
        ...
        _buildDetailRow('Enterprise ID', restaurant.enterpriseId ?? 'N/A'),
        if (restaurant.updatedAt != null)
          _buildDetailRow('Last Updated', _formatDateTime(restaurant.updatedAt!)),
      ],
    );
  }
