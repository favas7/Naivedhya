    ...
    return Column(
      ...
      children: [
        ...
        if (staff.assignedOrders.isNotEmpty) ...[
          ...
          Text(
            'Orders: ${staff.activeOrdersCount}',
            style: const TextStyle(
              fontWeight: FontWeight.w500,
              color: Colors.blue,
              fontSize: 12,
  ...
  void _showDetailsDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text('${staff.displayName} Details'),
        content: SingleChildScrollView(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            mainAxisSize: MainAxisSize.min,
            children: [
              _buildDetailRow('Name', staff.displayName),
              ...
              _buildDetailRow('Vehicle', staff.vehicleInfo),
              ...
              _buildDetailRow('Assigned Orders', staff.activeOrdersCount.toString()),
            ],
          ),
        ),
        actions: [
