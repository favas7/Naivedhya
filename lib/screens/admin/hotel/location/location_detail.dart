...
import 'package:naivedhya/screens/admin/hotel/location/edit_location.dart';
...
class _LocationDetailScreenState extends State<LocationDetailScreen> {
  ...
  Future<void> _loadLocations() async {
    ...
    try {
      final locations = await _supabaseService.getLocations(widget.hotel.id!);
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('${widget.hotel.name} - Locations'),
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              'Add your first location for ${widget.hotel.name}',
              style: TextStyle(
                fontSize: 14,
