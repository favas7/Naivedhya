...
import 'package:naivedhya/screens/admin/hotel/menu/widgets/menu_item_card.dart';
...
class MenuManagementScreen extends StatefulWidget {
  ...
  const MenuManagementScreen({
    super.key,
    required this.hotel, required Future<void> Function() onMenuUpdated,
  });
...
class _MenuManagementScreenState extends State<MenuManagementScreen> {
  ...
  Future<void> _loadMenuData() async {
    ...
    try {
      final items = await _menuService.getMenuItems(widget.hotel.id!);
      final categories = await _menuService.getMenuCategories(widget.hotel.id!);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('${widget.hotel.name} - Menu'),
