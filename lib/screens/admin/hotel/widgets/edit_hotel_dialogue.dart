...
class HotelCard extends StatefulWidget {
  final Hotel hotel;
  final VoidCallback? onHotelUpdated; // Callback to refresh the hotel list
...
class _HotelCardState extends State<HotelCard> {
  ...
  void _showEditBasicInfoDialog() {
    showDialog(
      ...
      builder: (context) => EditHotelBasicInfoDialog(
        hotel: widget.hotel,
        onSuccess: () {
          widget.onHotelUpdated?.call(); // Refresh the hotel list
        },
      ),
    );
  }
  ...
  void _showEditDialog() {
    // showDialog(
    //   context: context,
    //   builder: (context) => EditHotelDialog(hotel: widget.hotel),
    // );
  }
